...
function insertNewRecord(data) {
    ...
    cell1 = newRow.insertCell(0);
		cell1.innerHTML = data.aluno;
    cell2 = newRow.insertCell(1);
		cell2.innerHTML = data.nota1;
    cell3 = newRow.insertCell(2);
		cell3.innerHTML = data.nota2;
...
function onEdit(td) {
    ...
    document.getElementById("media").value = selectedRow.cells[3].innerHTML;
    document.getElementById("situacao").value = selectedRow.cells[4].innerHTML;
}
function updateRecord(formData) {
    ...
    selectedRow.cells[3].innerHTML = formData.media;
    selectedRow.cells[4].innerHTML = formData.situacao;
}
